...
class ExperienciaLaboralsControllerTest < ActionController::TestCase
  setup do
  ...
  test "should get index" do
    ...
    assert_not_nil assigns(:experiencia_laborals)
  end
  ...
  test "should destroy experiencia_laboral" do
    ...
    assert_redirected_to experiencia_laborals_path
  end
end
