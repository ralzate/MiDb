...
class InformacionAcademicasControllerTest < ActionController::TestCase
  setup do
  ...
  test "should get index" do
    ...
    assert_not_nil assigns(:informacion_academicas)
  end
  ...
  test "should destroy informacion_academica" do
    ...
    assert_redirected_to informacion_academicas_path
  end
end
