...
class InformacionesAcademicasControllerTest < ActionController::TestCase
  setup do
    @informacion_academica = informaciones_academicas(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:informaciones_academicas)
  end
  ...
  test "should destroy informacion_academica" do
    ...
    assert_redirected_to informaciones_academicas_path
  end
end
